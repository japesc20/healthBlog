...
const Data = [
 {
  ...
  },
  {
    ...
    subCategory: ['exercise', 'diet', 'health'],
    description: 
     "Lorem Ipsum is simple dummy text of the printing of typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a gallery of type and scrambled it to make a type specimen book.",
    authorName: 'Jacob Petrakovitz',
    authorAvatar: '/assets/images/profile-pic.jpg',
    createdAt: 'Jan 8, 2022',
